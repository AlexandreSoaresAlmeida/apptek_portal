        ...
        <div class="card-body">
            <form action={{ route('pages.store') }} class="form-horizontal" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Informe o título" value="{{old('title')}}" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <span class="col-sm-10">
                    <button type="submit" class="btn btn-flat margin btn-success btn-normal" >Criar</button>
